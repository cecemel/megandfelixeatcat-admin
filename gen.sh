...
edi ember g mu-resource "food-establishment&schema:FoodEstablishment" "establishment-name:string&schema:name" "ratings:has-many:rating~food-establishment&schema:starRating" "reviews:has-many:review~food-establishment"
...
edi ember g mu-resource "review&schema:Review" "review-body:string&schema:reviewBody" "headline:string&meg:reviewHeadline" "created:date&dct:created" "rating:belongs-to:rating~review&schema:reviewRating" "food-establishment:belongs-to:food-establishment~reviews&schema:itemReviewed" "authors:has-many:reviewer&schema:author"
