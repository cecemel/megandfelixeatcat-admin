...
edi ember g mu-resource "food-establishment&schema:FoodEstablishment" "establishment-name:string&schema:name" "ratings:has-many:rating&schema:starRating" "reviews:has-many:review~food-establishment"
